    ...
    public static void main(final String[] args) {
        try {
            ...
            if (args.length > 0) {
                ...
                url = HelloWorld.class.getResource("hello.config.xml");
            }
		...
		while (true) {
		    ...
		    if (result != null) {
			final String resultText = result.getBestFinalResultNoFiller();
